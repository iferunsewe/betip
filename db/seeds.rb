...
u1 = User.create!(name: "Ari Gold", email: "arigold@email.com", password: "password", role: "Tipster", price: 12.00, win_percentage: 95.00)
u2 = User.create!(name: "Vincent Chase", email: "vincentchase@email.com", password: "password", role: "Tipster", price: 5.00, win_percentage: 85.00)
u3 = User.create!(name: "Johnny Drama", email: "johnnydrama@email.com", password: "password", role: "Customer", win_percentage: 0)
u4 = User.create!(name: "Eric Murphy", email: "ericmurphy@email.com", password: "password", role: "Customer", win_percentage: 0)
u5 = User.create!(name: "Danny Dyer", email: "dannydyer@email.com", password: "password", role: "Tipster", price: 4.00, win_percentage: 73.00)
u6 = User.create!(name: "Mark Corrigan", email: "markcorrigan@email.com", password: "password", role: "Tipster", price: 9.00, win_percentage: 87.00)
