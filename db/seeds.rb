t1 = Tip.create!(bookies: "Ladbrokes", odds: 6.0, won: true, comment: "Bespoke VHS lomo food truck. Pitchfork gluten-free try-hard craft beer tote bag chambray. Brunch viral cronut kogi. Artisan roof party typewriter, direct trade butcher Pinterest gluten-free tattooed Blue Bottle sustainable.")
t2 = Tip.create!(bookies: "Bet365", odds: 5.5, won: false, comment: "Lomo migas fap chambray, hashtag selvage sustainable fingerstache scenester single-origin coffee roof party. Banksy selvage tote bag, before they sold out Shoreditch mixtape tilde DIY gastropub cliche kale chips Pitchfork pour-over hashtag roof party.")
t3 = Tip.create!(bookies: "Betfair", odds: 4.5, won: false, comment: "Neutra blog actually Kickstarter, Helvetica disrupt sriracha Brooklyn retro selfies chambray tattooed typewriter. Beard sartorial readymade, flannel selfies mustache vinyl.")
t4 = Tip.create!(bookies: "888.com", odds: 5.0, won: true, comment: "Mlkshk Echo Park pop-up street art, next level hoodie jean shorts wayfarers Brooklyn Intelligentsia. Roof party farm-to-table gluten-free, pour-over hashtag banjo Etsy Tumblr.")
...
p2 = Prediction.create!(homeTeam: "Liverpool", awayTeam: "Everton", date: DateTime.parse("16/12/2014 15:00"), predictionGoalsHomeTeam: 1, predictionGoalsAwayTeam: 1, type_of_bet_id: tb13.id)
