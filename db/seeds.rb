...
p1 = Prediction.create!(homeTeam: "Chelsea", awayTeam: "Arsenal", date: DateTime.parse("13/01/2015 15:00"), type_of_bet_id: tb1.id)
p2 = Prediction.create!(homeTeam: "Liverpool", awayTeam: "Everton", date: DateTime.parse("13/01/2015 15:00"), predictionGoalsHomeTeam: 1, predictionGoalsAwayTeam: 1, type_of_bet_id: tb12.id)
