...
class TipsControllerTest < ActionController::TestCase
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post :create, tip: { bookies: @tip.bookies, odds: @tip.odds, prediction_id: @tip.prediction_id, stake: @tip.stake, type: @tip.type, won: @tip.won }
    end
  ...
  test "should update tip" do
    put :update, id: @tip, tip: { bookies: @tip.bookies, odds: @tip.odds, prediction_id: @tip.prediction_id, stake: @tip.stake, type: @tip.type, won: @tip.won }
    assert_redirected_to tip_path(assigns(:tip))
  end
