...
class PredictionsControllerTest < ActionController::TestCase
  ...
  test "should create prediction" do
    assert_difference('Prediction.count') do
      post :create, prediction: { awayTeam: @prediction.awayTeam, date: @prediction.date, homeTeam: @prediction.homeTeam, predictionGoalsAwayTeam: @prediction.predictionGoalsAwayTeam, predictionGoalsHomeTeam: @prediction.predictionGoalsHomeTeam }
    end
  ...
  test "should update prediction" do
    put :update, id: @prediction, prediction: { awayTeam: @prediction.awayTeam, date: @prediction.date, homeTeam: @prediction.homeTeam, predictionGoalsAwayTeam: @prediction.predictionGoalsAwayTeam, predictionGoalsHomeTeam: @prediction.predictionGoalsHomeTeam }
    assert_redirected_to prediction_path(assigns(:prediction))
  end
